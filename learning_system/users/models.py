...
class Student(User):
    study_group = models.ForeignKey('users.StudyGroup', on_delete=models.CASCADE, blank=True, null=True, related_name='students',
...
class Teacher(User):
    study_groups = models.ManyToManyField('users.StudyGroup', related_name='teachers',
...
class StudyGroup(models.Model):
    ...
    available_subjects = models.ManyToManyField(Course, verbose_name='Доступные курсы', blank=True)
...
class StudentProgress(models.Model):
    ...
    practice_task = models.ForeignKey('practice.PracticeTask', on_delete=models.CASCADE, verbose_name='Задача')
