...
router.register(r'group/list', student_api.StudyGroupView)
router.register(r'group/create', student_api.StudyGroupCreateView)    
router.register(r'student/create', student_api.StudentCreateView)    
router.register(r'teacher/create', teacher_api.TeacherCreateView)    
router.register(r'student_progress/create', student_api.StudentProgressCreateView)    
router.register(r'user_complaint/create', user_api.UserComplaintCreateView)    
...
router.register(r'add_study_group_to_course', user_api.AddCourseToStudyGroupView)    
