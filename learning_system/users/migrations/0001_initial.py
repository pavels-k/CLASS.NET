    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('available_subjects', models.ManyToManyField(blank=True, to='courses.Course', verbose_name='Доступные курсы')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('user_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to=settings.AUTH_USER_MODEL)),
                ('study_groups', models.ManyToManyField(related_name='teachers', to='users.StudyGroup', verbose_name='Учебные группы')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('practice_task', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='practice.PracticeTask', verbose_name='Задача')),
        ...
        migrations.AddField(
            model_name='student',
            name='study_group',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='students', to='users.StudyGroup', verbose_name='Учебная группа'),
        ),
        migrations.CreateModel(
